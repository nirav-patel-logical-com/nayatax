        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>{{ trans('label_word.farmer_report') }}</span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
                    ...
                    <div class="portlet">
                        <div class="portlet-title" style="background-color: white; border: 1px solid #eee;">
                            <div class="caption" style="margin-left: 1%;">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">{{ trans('label_word.farmer_report') }}</span>
                            </div>
                                    ...
                                    <form id="frm">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="row margin-top-10">
                                                <div class="col-md-3">
                                                    <label for="single-seller"
                                                           class="control-label text-bold">{{ trans('label_word.farmer_name') }}&nbsp;:</label>
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="farmer_name" id="farmer_name" placeholder="{{ trans('label_word.farmer_name') }}">
                                                </div>
                                            </div>
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-body">
                            <table class="table table-bordered" id="posts">
                                <thead>
                                <tr>
                                    <th width="10%"> {{ trans('label_word.date') }}</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#posts').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                "url": "<?php echo route('farmer_report_post'); ?>",
                "dataType": "json",
                "type": "POST",
                "data":function(d){
