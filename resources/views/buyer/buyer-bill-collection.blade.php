...
<div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>{{ trans('label_word.buyer_bill_collection') }}</span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title"> {{ trans('label_word.buyer_bill_collection') }}</h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">{{ trans('label_word.buyer_bill_collection') }}</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form role="form">
                                <input type="hidden" id="bi_id" value="{{$data['buyer_data']->bi_id}}" name="bi_id">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="input-icon margin-top-10">
                                                    ...
                                                    <input type="text" class="form-control" id="company" name="company"
                                                           value="{{$data['buyer_data']->biz_name}}"
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="input-icon margin-top-10">
                                                    ...
                                                    <input type="text" class="form-control" id="seller" name="seller"
                                                           value="{{$data['buyer_data']->buyer_name}}"
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="input-icon margin-top-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Amount"
                                                           id="total" name="total"
                                                           value="{{$data['buyer_data']->bi_total}}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="<?php echo route('buyer_bills_list'); ?>"
    ...
    <script type="text/javascript">
        ...
        $("#btnsubmit").click(function () {
            ...
            if (flag == 0) {
                $.ajax({
                    url: '<?php echo route('buyer_update_payment_type');?>',
                    method: 'POST',
                    data: {
                        'bi_id': bi_id,
                        'bank_name': bank_name,
