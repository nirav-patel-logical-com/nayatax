        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>{{ trans('label_word.farmer_invoice_list') }}</span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">{{ trans('label_word.farmer_invoice_list') }}</h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <!-- BEGIN CREATE ADMIN-->
            <div class="row">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">{{ trans('label_word.farmer_invoice_list') }}</span>
                            </div>
                            <div class="actions">
                                <div class="btn-group btn-group-devided">
                                   ...
                                   <!-- <a id="sample_editable_1_new" class="btn sbold green add" href="<?php //echo route('stock_in');?>"
                        ...
                        <div class="portlet-body">
                            <table class="table table-bordered" id="posts">
                                ...
                                <tr>
                                    ...
                                    <th> {{ trans('label_word.qty') }}</th>
                                    <th> {{ trans('label_word.amount') }}</th>
                                    <th> {{ trans('label_word.payment_type') }}</th>
...
<script>
    $(document).ready(function () {
        $('#posts').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                "url": "<?php echo route('seller_bill_collection_list_post'); ?>",
                "dataType": "json",
                "type": "POST",
