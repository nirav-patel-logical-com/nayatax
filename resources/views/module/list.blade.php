        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span>{{ trans('label_word.module_list') }}</span>
                    </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">{{ trans('label_word.module_list') }}</h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <!-- BEGIN CREATE ADMIN-->
            <div class="row">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">{{ trans('label_word.module_list') }}</span>
                            </div>
                            <div class="actions">
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                    ...
                                    <a id="sample_editable_1_new" class="btn sbold green"
                                       href="<?php echo route('module_create'); ?>"
                        ...
                        <div class="portlet-body">
                            <table class="table table-bordered" id="posts">
                                ...
                                <tr>
                                    ...
                                    <th>{{ trans('label_word.group') }}</th>
                                    <th>{{ trans('label_word.add_date') }}</th>
...
<script>
    $(document).ready(function () {
        $('#posts').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo route('module_list_post'); ?>",
                "dataType": "json",
                "type": "POST",
